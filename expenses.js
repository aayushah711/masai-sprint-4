...
if (currentUser) {
	// If current user is available: fetch its data
...
function userBalance() {
	...
	user.balance[activeDate.toDateString()]['balance'] =
		Number(user.balance[activeDate.toDateString()]['incomes']) -
		Number(user.balance[activeDate.toDateString()]['expenses']);
